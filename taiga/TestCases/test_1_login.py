...
class TestLogin:
    ...
    def test_login_success(self):
        self.login_page.login(gd.login_admin_success["username"], gd.login_admin_success["password"])
        self.login_page.wait_page_url_change(gd.login_url)
        assert self.login_page.get_page_url() == gd.home_url

    def test_login_out(self):
        self.login_page.logout()
        self.login_page.wait_page_url_change(gd.base_url)
        assert self.login_page.get_page_url() == gd.discover_url
